    ...
    <div class="tab-content">
        ...
        <div class="col-md-4">    
            ...
            <md-outlined-select label="Konfigurasi" class="label"  id="konfigurasi" name="konfigurasi" disabled>
                ...
                <md-select-option disabled value="2S+1F" {{ (old('konfigurasi', $siteSurvey->jenis_perkakasuis ?? '') == '2S+1F') ? 'selected' : '' }}>2S+1F</md-select-option>
                <md-select-option disabled value="2S+2F" {{ (old('konfigurasi', $siteSurvey->jenis_perkakasuis ?? '') == '2S+2F') ? 'selected' : '' }}>2S+2F</md-select-option>
                <md-select-option disabled value="3S" {{ (old('konfigurasi', $siteSurvey->jenis_perkakasuis ?? '') == '3S') ? 'selected' : '' }}>3S</md-select-option>
                <md-select-option disabled value="3S+1F" {{ (old('konfigurasi', $siteSurvey->jenis_perkakasuis ?? '') == '3S+1F') ? 'selected' : '' }}>3S+1F</md-select-option>
                <md-select-option disabled value="3S+2F" {{ (old('konfigurasi', $siteSurvey->jenis_perkakasuis ?? '') == '3S+2F') ? 'selected' : '' }}>3S+2F</md-select-option>
        ...
        <div class="col-md-4">     
                <div class="form-group">
                    ...
                    <md-outlined-text-field disabled label="Tahun Pembinaan" class="label" type="date"  id="tahun_pembinaan" name="tahun_pembinaan" value="{{ $siteSurvey->tahun_pembinaan ?? old('tahun_pembinaan') }}">
                </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <md-outlined-text-field disabled type="text" class="label" label="Suis No {{ $i }}"  id="suis_no{{ $i }}" name="suis_no{{ $i }}" value="{{ $siteSurvey->{"suis_no{$i}"} ?? old("suis_no{$i}") }}">
            </div>
        </div>
        ...
        <div class="col-md-4"> 
                    <div class="form-group">
                        ...
                        <md-outlined-text-field  disabled type="text" label="Suis Label {{ $i }}" class="label"  id="suis_label{{ $i }}" name="suis_label{{ $i }}" value="{{ $siteSurvey->{"suis_label{$i}"} ?? old("suis_label{$i}") }}">
                    </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-container" style="margin-top:5px">
                    <input  disabled type="date" style=" height:50px !important;border-radius: 5px !important;width:60% !important;" id="tarikh" name="tarikh" value="{{ $toolboxTalk->tarikh ?? old('tarikh') }}" required>
                    <label>Tarikh</label>
                </div>
            </div>
