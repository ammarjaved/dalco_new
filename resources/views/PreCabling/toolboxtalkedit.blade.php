...
<div class="input-container" style="margin-top:5px">
    <input type="date" id="tarikh" class="label" name="tarikh" value="{{ $toolboxtalk->tarikh }}" required>
    <label for="tarikh">Tarikh</label>
</div>
</div>    
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <md-outlined-text-field label="Skop Kerja" class="label" type="text" id="skop_kerja" name="skop_kerja" class="form-control" value="CABLING" readonly>
        </div>
    </div>
...
<form action="{{ route('PreCabling.toolboxtalk.destroy', $toolboxtalk->id) }}" method="POST" style="display: inline;">
 ...
 <script>
    ...
    document.getElementById(`${field}_${value}`).checked = true;
}
