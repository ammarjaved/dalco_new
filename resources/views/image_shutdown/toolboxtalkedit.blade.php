...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <md-outlined-text-field label="Skop Kerja" class="label" type="text" id="skop_kerja" name="skop_kerja" class="form-control" value="OUTAGE" readonly>
        </div>
    </div>
 ...
 <div class="mt-3" id="button-container">
    ...
    <div class="mt-3">
        <form action="{{ route('toolbox-talk.destroy', $toolboxtalk->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this Toolbox Talk?');">
            @csrf
            @method('DELETE')
            <md-filled-tonal-button style="margin-left:190px; margin-top:-90px" type="submit" >Delete Toolbox</md-filled-tonal-button>
        </form>
    </div>
 @endsection 
