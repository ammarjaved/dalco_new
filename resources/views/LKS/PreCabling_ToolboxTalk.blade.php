...
<head>
    ...
    <title>PreCabling Toolbox Talk_{{$survey->nama_pe}}</title>
    ...
    <div id="content" class="container">
        <div style="break-after:page">
            ...
            <div class="container-fluid">
                <table>
                    <tr>
                        <th>Lokasi</th>
                        <td>{{$PreCablks->lokasi}}</td>
                        <th>Tarikh</th>
                        <td>{{$PreCablks->tarikh}}</td>
                    </tr>
                    <tr>
            ...
            <h4 class="title center-text">Pre Cabling</h4>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col">
                        <div class="row border">
                            {{strtoupper($PreCablks->ppd_safety_helment)}}
                        </div>
                        <div class="row border">
                            {{strtoupper($PreCablks->ppd_safety_vest)}}
                        </div>
                        <div class="row border">
                            {{strtoupper($PreCablks->ppd_safety_shoes)}}
                        </div>
                        <div class="row border">
                            {{strtoupper($PreCablks->ppd_safety)}}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="row border">
                            {{strtoupper($PreCablks->equipment_condition)}}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="row border">
                            {{strtoupper($PreCablks->instrument_condition)}}
                        </div>
                        <div class="row border">
                            {{strtoupper($PreCablks->instrument_kit_condition)}}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="row border">
                            {{strtoupper($PreCablks->vehicle_fire_extinguisher)}}
                        </div>
                        <div class="row border">
                            {{strtoupper($PreCablks->vehicle_condition)}}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="row border">
                            {{strtoupper($PreCablks->traffic_safety_kon)}}
                        </div>
                        <div class="row border">
                            {{strtoupper($PreCablks->traffic_sign_board)}}
                        </div>
                        <div class="row border">
                            {{strtoupper($PreCablks->traffic_chargeman)}}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="row border">
                            {{strtoupper($PreCablks->team_ap_tnp)}}
                        </div>
                        <div class="row border">
                            {{strtoupper($PreCablks->team_cp_tnb)}}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="row border">
                            {{strtoupper($PreCablks->niosh_staff_ntsp)}}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="row border">
                            {{strtoupper($PreCablks->permit_special)}}
                        </div>
                        <div class="row border">
                            {{strtoupper($PreCablks->permit_work)}}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="row border">
                            {{strtoupper($PreCablks->picture_during_toolbox)}}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div style="break-after:page">
            ...
            <div class="img-container">
                <img src='/{{$PreCablks->toolbox_image1}}' alt="Toolbox Talk Image 1">
                <img src='/{{$PreCablks->toolbox_image2}}' alt="Toolbox Talk Image 2">
            </div>
